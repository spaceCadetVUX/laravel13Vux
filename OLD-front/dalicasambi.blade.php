...
@extends('front.layouts.frontend', [
    'seo' => [
        'title'          => __('dali.seo.title'),
        'description'    => __('dali.seo.description'),
        'keywords'       => __('dali.seo.keywords'),
        'og_title'       => __('dali.seo.og_title'),
        'og_description' => __('dali.seo.og_description'),
        'image'          => $daliOgImage,
...
@php
    $daliFaqs = $locale === 'vi' ? [
        ['q' => 'DALI là gì?',
         'a' => 'DALI (Digital Addressable Lighting Interface) là giao thức điều khiển chiếu sáng kỹ thuật số theo tiêu chuẩn IEC 62386, cho phép điều khiển từng bộ đèn riêng lẻ với độ chính xác cao qua đường truyền 2 dây.'],
        ['q' => 'Casambi DALI khác gì so với DALI truyền thống?',
         'a' => 'Casambi DALI kết hợp giao thức DALI chuẩn với giao diện điều khiển không dây Bluetooth Mesh của Casambi, giúp vận hành toàn bộ hệ thống DALI qua smartphone/tablet mà không cần phần mềm máy tính chuyên dụng.'],
        ['q' => 'DALI có tích hợp được với hệ thống BMS không?',
         'a' => 'Có. DALI hỗ trợ tích hợp với hệ thống quản lý tòa nhà (BMS) thông qua gateway DALI-BACnet hoặc DALI-KNX, cho phép giám sát và điều khiển tập trung toàn bộ hệ thống chiếu sáng.'],
        ['q' => 'Một mạng DALI có thể kết nối tối đa bao nhiêu thiết bị?',
         'a' => 'Một phân đoạn mạng DALI chuẩn hỗ trợ tối đa 64 địa chỉ thiết bị và 16 nhóm. Với Casambi DALI, nhiều phân đoạn có thể được quản lý trong cùng một hệ thống qua Bluetooth Mesh.'],
        ['q' => 'DALI phù hợp với loại công trình nào?',
         'a' => 'DALI đặc biệt phù hợp với tòa nhà văn phòng, trung tâm thương mại, bệnh viện, trường học và các công trình công nghiệp đòi hỏi điều khiển chiếu sáng chính xác và khả năng giám sát tiêu thụ điện năng.'],
    ] : [
        ['q' => 'What is DALI?',
         'a' => 'DALI (Digital Addressable Lighting Interface) is a digital lighting control protocol per IEC 62386 standard, enabling individual control of each luminaire with high precision over a 2-wire bus.'],
        ['q' => 'How is Casambi DALI different from traditional DALI?',
         'a' => 'Casambi DALI combines the standard DALI protocol with Casambi\'s Bluetooth Mesh wireless interface, allowing the entire DALI system to be operated via smartphone or tablet without dedicated PC software.'],
        ['q' => 'Can DALI integrate with a BMS system?',
         'a' => 'Yes. DALI supports integration with building management systems (BMS) via DALI-BACnet or DALI-KNX gateways, enabling centralized monitoring and control of the entire lighting infrastructure.'],
        ['q' => 'How many devices can a DALI network support?',
         'a' => 'A standard DALI segment supports up to 64 device addresses and 16 groups. With Casambi DALI, multiple segments can be managed within the same system via Bluetooth Mesh.'],
        ['q' => 'What types of projects is DALI best suited for?',
         'a' => 'DALI is especially suitable for office buildings, shopping centers, hospitals, schools, and industrial facilities requiring precise lighting control and energy consumption monitoring.'],
    ];
    ...
    $breadcrumbSchema = [
        ...
        'itemListElement' => [
            ...
            [
                '@type'    => 'ListItem',
                'position' => 2,
                'name'     => $locale === 'vi' ? 'DALI Casambi' : 'Casambi DALI',
                'item'     => $pageUrl,
            ],
        ],
    ];
                ...
                <div class="row align-items-center g-5 dali-hero__row">
                    ...
                    <div class="col-lg-6">
                        <div class="dali-hero__visual">
                            <!-- IMAGE: Replace with DALI installation / Casambi app photo -->
                    ...
                    <div class="col-lg-12">
                        <div class="app-feature-heading text-center mb-55">
                            ...
                            <div class="tp_fade_anim" data-delay=".7">
                                <p>{{ __('dali.feature.subheading') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-10">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="app-feature-item mb-30" style="background: #ffffff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                                <div class="app-feature-item-icon">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" style="color: #ff581e;" width="28" height="26" viewBox="0 0 28 26" fill="none">
                                            <g>
                                                <path d="M11.1391 14.1861H15.1554V23.5445C15.1554 24.9222 16.8711 25.5721 17.7809 24.5323L27.6202 13.3542C28.478 12.3794 27.7891 10.8587 26.4894 10.8587H22.4731V1.50026C22.4731 0.1225 20.7574 -0.527389 19.8476 0.512433L10.0083 11.6905C9.16348 12.6653 9.85235 14.1861 11.1391 14.1861Z" fill="currentColor"/>
                                                <path d="M10.0732 3.09894H0.974825C0.441921 3.09894 0 2.65702 0 2.12411C0 1.5912 0.441921 1.14928 0.974825 1.14928H10.0732C10.6061 1.14928 11.048 1.5912 11.048 2.12411C11.048 2.65702 10.6061 3.09894 10.0732 3.09894Z" fill="currentColor"/>
                                                <path d="M8.77343 23.8956H0.974825C0.441921 23.8956 0 23.4536 0 22.9207C0 22.3878 0.441921 21.9459 0.974825 21.9459H8.77343C9.30633 21.9459 9.74825 22.3878 9.74825 22.9207C9.74825 23.4536 9.30633 23.8956 8.77343 23.8956Z" fill="currentColor"/>
                                                <path d="M4.87413 13.4972H0.974825C0.441921 13.4972 0 13.0553 0 12.5224C0 11.9895 0.441921 11.5476 0.974825 11.5476H4.87413C5.40703 11.5476 5.84895 11.9895 5.84895 12.5224C5.84895 13.0553 5.40703 13.4972 4.87413 13.4972Z" fill="currentColor"/>
                                            </g>
                                        </svg>
                                    </span>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="app-feature-item mb-30" style="background: #ffffff; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                                <div class="app-feature-item-icon">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" style="color: #ff581e;" width="27" height="28" viewBox="0 0 27 28" fill="none">
                                            <path d="M20.864 12.3287C20.8913 12.683 20.7686 13.0509 20.4961 13.3234L12.2926 21.5268C10.4803 23.3391 8.65425 23.3391 6.82824 21.5268L1.36383 16.0624C0.437199 15.1222 -0.0261177 14.1819 0.00113616 13.2417H0.0965244L20.7005 12.3423L20.864 12.3287Z" fill="currentColor"/>
                                            <path d="M20.4959 11.4976L9.29459 0.296382C8.89941 -0.0987938 8.24531 -0.0987938 7.85013 0.296382C7.45495 0.691557 7.45495 1.34564 7.85013 1.74081L9.03568 2.92633L1.36371 10.5982C0.491583 11.4703 0.0283901 12.3559 0.00113616 13.2417H0.0965244L20.7005 12.3423L20.864 12.3287C20.8504 12.0289 20.714 11.7156 20.4959 11.4976Z" fill="currentColor"/>
                                            <path d="M19.0788 28H1.36382C0.805111 28 0.341795 27.5367 0.341795 26.978C0.341795 26.4193 0.805111 25.956 1.36382 25.956H19.0788C19.6376 25.956 20.1009 26.4193 20.1009 26.978C20.1009 27.5367 19.6376 28 19.0788 28Z" fill="currentColor"/>
                                            <path d="M23.644 17.1392C23.2897 16.7577 22.6356 16.7577 22.2813 17.1392C21.8588 17.6025 19.7603 19.9735 19.7603 21.7586C19.7603 23.5301 21.1911 24.961 22.9626 24.961C24.7341 24.961 26.165 23.5301 26.165 21.7586C26.165 19.9735 24.0664 17.6025 23.644 17.1392Z" fill="currentColor"/>
                                        </svg>
                                    </span>
                                </div>
                                <div class="app-feature-item-content">
                ...
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6">
                        <div class="dali-sys-img-wrap">
                            <img src="{{ asset('images/casambi/HybridDALISystem.jpg') }}" alt="Hybrid DALI System" onerror="this.style.background='linear-gradient(135deg,#ede9fe,#ddd6fe)';this.removeAttribute('src')">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="dali-sys-feats">
                            <div class="dali-sys-feat">
                                <div class="dali-sys-feat__icon">
                                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#ff581e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </div>
                                <div>
                                    <div class="dali-sys-feat__title">{{ __('dali.sys.feat1_title') }}</div>
                                    <div class="dali-sys-feat__sub">{{ __('dali.sys.feat1_sub') }}</div>
                                </div>
                            </div>
                            <div class="dali-sys-feat">
                                <div class="dali-sys-feat__icon">
                                    <svg width="18" height="18" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="#ff581e" stroke-width="2"/><path d="M8 12l3 3 5-5" stroke="#ff581e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                                </div>
                                <div>
                                    <div class="dali-sys-feat__title">{{ __('dali.sys.feat2_title') }}</div>
                                    <div class="dali-sys-feat__sub">{{ __('dali.sys.feat2_sub') }}</div>
                                </div>
                            </div>
                            <div class="dali-sys-feat">
                                <div class="dali-sys-feat__icon">
                                ...
                                <div>
                                    <div class="dali-sys-feat__title">{{ __('dali.sys.feat3_title') }}</div>
                                    <div class="dali-sys-feat__sub">{{ __('dali.sys.feat3_sub') }}</div>
                                </div>
                            </div>
                        </div>

                        <a href="#" class="dali-sys-cta">{{ __('dali.sys.cta') }}
                ...
                <div class="dali-sys-apps">
                    <div class="dali-sys-apps__group">
                        ...
                        <div class="dali-sys-apps__chips">
                            @foreach(explode('|', __('dali.sys.apps_chips1')) as $chip)
                                <span>{{ $chip }}</span>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="dali-sys-apps__group">
                        ...
                        <div class="dali-sys-apps__chips">
                            @foreach(explode('|', __('dali.sys.apps_chips2')) as $chip)
                                <span>{{ $chip }}</span>
                            @endforeach
                        </div>
                    </div>
        ...
        <div class="app-stack-area app-stack-ptb app-stack-box stack-panel-pin-area">
            <div class="app-stack-contain">
                <div class="app-stack-item stack-item app-stack-item-01 stack-panel-pin pt-200 pb-200 atropos" data-atropos data-bg-color="#f8f7fd">
                    <div class="app-stack-warpper">
                        <div class="container container-1230">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="app-stack-heading">
                                        <span class="app-stack-subtitle">{{ __('dali.stack.s1_subtitle') }}</span>
                                        <h4 class="app-stack-number">01</h4>
                                        <h3 class="app-stack-title">{!! __('dali.stack.s1_title') !!}</h3>
                                        <div class="app-stack-content">
                                            <p>{{ __('dali.stack.s1_desc') }}</p>
                                            <div class="app-stack-btn">
                                                <a href="#">{{ __('dali.stack.s1_btn') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="dali-stack-img-wrap">
                                        <img src="{{ asset('images/casambi/withoutlimitations.jpeg') }}" alt="DALI Project">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="app-stack-warpper">
                        <div class="container container-1230">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="app-stack-heading">
                                        <span class="app-stack-subtitle">{{ __('dali.stack.s2_subtitle') }}</span>
                                        <h4 class="app-stack-number">02</h4>
                                        <h3 class="app-stack-title">{!! __('dali.stack.s2_title') !!}</h3>
                                        <div class="app-stack-content">
                                            <p>{{ __('dali.stack.s2_desc') }}</p>
                                            <div class="app-stack-btn">
                                                <a href="#">{{ __('dali.stack.s2_btn') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="dali-stack-img-wrap">
                                        <img src="{{ asset('images/casambi/withouttheheadaches-Picsart-AiImageEnhancer.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="app-stack-warpper">
                        <div class="container container-1230">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="app-stack-heading">
                                        <span class="app-stack-subtitle">{{ __('dali.stack.s3_subtitle') }}</span>
                                        <h4 class="app-stack-number">03</h4>
                                        <h3 class="app-stack-title">{!! __('dali.stack.s3_title') !!}</h3>
                                        <div class="app-stack-content">
                                            <p>{{ __('dali.stack.s3_desc') }}</p>
                                            <div class="app-stack-btn">
                                                <a href="#">{{ __('dali.stack.s3_btn') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="dali-stack-img-wrap">
                                        <img src="{{ asset('images/casambi/yourfingertips.jpg') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
