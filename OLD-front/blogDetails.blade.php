@extends('front.layouts.frontend', [
    'seo' => [
        ...
        'keywords'       => !empty($blog->tags) ? implode(', ', (array) $blog->tags) : '',
        ...
        'type'           => 'article',
        'canonical'      => route(app()->getLocale() . '.blog.show', $blog->slug),
        'robots'         => $blog->indexable ? 'index, follow' : 'noindex, nofollow',
        'hreflangs'      => [
        ...
        <div class="row gx-lg-5">
            ...
            <main class="col-lg-8">
                ...
                <div class="blog-tags">
                    ...
                    @foreach($blog->tags as $tag)
                    <a href="{{ route(current_locale() . '.blog.search') }}?q={{ urlencode($tag) }}" class="blog-tags__item">{{ $tag }}</a>
                    @endforeach
                </div>
                @endif
            ...
            <aside class="col-lg-4 mt-5 mt-lg-0">
                <div class="blog-sidebar">
                    ...
                    <div class="sidebar-section">
                        ...
                        <form class="sidebar-search-wrap" action="{{ route(current_locale() . '.blog.search') }}" method="GET">
                    ...
                    <div class="sidebar-section">
                        ...
                        <div class="sidebar-tags">
                            ...
                            <a href="{{ route(current_locale() . '.blog.search') }}?q={{ urlencode($tag) }}" class="sidebar-tag-item">{{ $tag }}</a>
                            @endforeach
                        </div>
                    </div>
                    @endif
