    ...
    <div class="container">
        <div class="row pt-5 pb-4 g-4">
            ...
            <div class="col-xl-2 col-lg-2 col-6 offset-xl-2 offset-lg-2">
                <div class="footer-col">
                    ...
                    <ul class="footer-links">
                        <li><a href="{{ route('home') }}">{{ __('footer.page_home') }}</a></li>
            ...
            <!-- <div class="col-xl-2 col-lg-2 col-6">
                <div class="footer-col">
                    <h3 class="footer-col-heading">{{ __('footer.company_heading') }}</h4>
                    <ul class="footer-links">
                        <li><a href="#">{{ __('footer.company_about') }}</a></li>
                        <li><a href="#">{{ __('footer.company_projects') }}</a></li>
                        <li><a href="#">{{ __('footer.company_partners') }}</a></li>
                        <li><a href="#">{{ __('footer.company_careers') }}</a></li>
                    </ul>
                </div>
            </div> -->
