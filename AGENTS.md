...
This project is indexed by GitNexus as **backbone** (7965 symbols, 24135 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
