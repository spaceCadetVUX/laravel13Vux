...
This project is indexed by GitNexus as **backbone** (8409 symbols, 25121 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
