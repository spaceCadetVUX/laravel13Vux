...
export function registerSprint5Tools(server) {
    server.tool("bulk_seo_fill", "Điền SEO meta hàng loạt cho nhiều entity. Tối đa 50 items mỗi lần.", {
    ...
    server.tool("bulk_translate", "Dịch hàng loạt content sang locale khác. Tối đa 20 items mỗi lần.", {
        items: z.array(z.object({
            model_type: z.enum(["product", "category", "blog_post", "blog_category", "brand", "manufacturer"]).describe("Loại entity"),
            slug: z.string().describe("Entity slug"),
