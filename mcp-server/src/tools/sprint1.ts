...
export function registerSprint1Tools(server: McpServer) {
  ...
  server.tool(
    "get_product_context",
    "Load full product context trước khi viết content. Gọi đầu tiên để hiểu sản phẩm.",
    {
  ...
  server.tool(
    "save_product",
    "Upsert product — tạo mới hoặc update content, translations, SEO, GEO/FAQ, attributes.",
    {
