...
This project is indexed by GitNexus as **backbone** (9135 symbols, 26670 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
