...
<head>
    ...
    <title>YourShop API Documentation</title>
    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-auth-register">POST /api/v1/auth/register
Register a new customer account.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-login">
                                <a href="#endpoints-POSTapi-v1-auth-login">POST /api/v1/auth/login
Login with email + password.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-google">
                                <a href="#endpoints-POSTapi-v1-auth-google">POST /api/v1/auth/google</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-auth-logout">
                                <a href="#endpoints-POSTapi-v1-auth-logout">POST /api/v1/auth/logout  [auth:sanctum]
Revoke current access token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-auth-me">
                                <a href="#endpoints-GETapi-v1-auth-me">GET /api/v1/auth/me  [auth:sanctum]
Return the authenticated user's profile.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-auth-me">
                                <a href="#endpoints-PUTapi-v1-auth-me">PUT /api/v1/auth/me  [auth:sanctum]
Update the authenticated user's name and/or phone.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories">
                                <a href="#endpoints-GETapi-v1-categories">GET /api/v1/categories
Return the full active category tree (root categories + nested children).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-categories--slug-">
                                <a href="#endpoints-GETapi-v1-categories--slug-">GET /api/v1/categories/{slug}
Return a single category with its paginated active products.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-products">
                                <a href="#endpoints-GETapi-v1-products">List products</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-products--slug-">
                                <a href="#endpoints-GETapi-v1-products--slug-">Get product detail</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-search">
                                <a href="#endpoints-GETapi-v1-search">GET /api/v1/search?q={term}&type={products|blog|all}&page={n}&per_page={n}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-cart">
                                <a href="#endpoints-GETapi-v1-cart">GET /api/v1/cart
Return the current cart. Creates one if none exists.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-cart">
                                <a href="#endpoints-DELETEapi-v1-cart">DELETE /api/v1/cart
Remove all items from the cart.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-cart-items">
                                <a href="#endpoints-POSTapi-v1-cart-items">POST /api/v1/cart/items
Add a product to the cart. Increments quantity if already present.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-cart-items--cartItem_id-">
                                <a href="#endpoints-PUTapi-v1-cart-items--cartItem_id-">PUT /api/v1/cart/items/{cartItem}
Set an item's quantity to an exact value.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-cart-items--cartItem_id-">
                                <a href="#endpoints-DELETEapi-v1-cart-items--cartItem_id-">DELETE /api/v1/cart/items/{cartItem}
Remove a single item from the cart.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-cart-merge">
                                <a href="#endpoints-POSTapi-v1-cart-merge">POST /api/v1/cart/merge  [auth:sanctum]
Merge guest cart into the authenticated user's cart.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-addresses">
                                <a href="#endpoints-GETapi-v1-addresses">GET /api/v1/addresses</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-addresses">
                                <a href="#endpoints-POSTapi-v1-addresses">POST /api/v1/addresses</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-addresses--id-">
                                <a href="#endpoints-PUTapi-v1-addresses--id-">PUT/PATCH /api/v1/addresses/{address}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-addresses--id-">
                                <a href="#endpoints-DELETEapi-v1-addresses--id-">DELETE /api/v1/addresses/{address}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-addresses--address_id--default">
                                <a href="#endpoints-PATCHapi-v1-addresses--address_id--default">PATCH /api/v1/addresses/{address}/default</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-orders">
                                <a href="#endpoints-GETapi-v1-orders">GET /api/v1/orders
Paginated order history for the authenticated user.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-orders">
                                <a href="#endpoints-POSTapi-v1-orders">POST /api/v1/orders
Place a new order from the current cart.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-orders--order_id-">
                                <a href="#endpoints-GETapi-v1-orders--order_id-">GET /api/v1/orders/{order}
Single order detail. Policy ensures user owns the order.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PATCHapi-v1-orders--order_id--cancel">
                                <a href="#endpoints-PATCHapi-v1-orders--order_id--cancel">PATCH /api/v1/orders/{order}/cancel
Cancel a pending order. Policy ensures user owns the order.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-blog">
                                <a href="#endpoints-GETapi-v1-blog">GET /api/v1/blog</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-blog-categories">
                                <a href="#endpoints-GETapi-v1-blog-categories">GET /api/v1/blog/categories
Returns the full tree: root categories with children eager-loaded.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-blog-tags">
                                <a href="#endpoints-GETapi-v1-blog-tags">GET /api/v1/blog/tags</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-blog--slug-">
                                <a href="#endpoints-GETapi-v1-blog--slug-">GET /api/v1/blog/{slug}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-blog--slug--comments">
                                <a href="#endpoints-GETapi-v1-blog--slug--comments">GET /api/v1/blog/{slug}/comments
Paginated approved comments for a published post.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-blog--slug--comments">
                                <a href="#endpoints-POSTapi-v1-blog--slug--comments">POST /api/v1/blog/{slug}/comments  (auth:sanctum)
Submit a comment — stored as is_approved=false until admin approves.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-register">POST /api/v1/auth/register
Register a new customer account.</h2>
...
<p>Must be at least 8 characters. Example: <code>-0pBNvYgxw</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-login">POST /api/v1/auth/login
Login with email + password.</h2>
...
<p>Example: <code>|]|{+-</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-google">POST /api/v1/auth/google</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Authenticate via Google ID token (sent from the Nuxt frontend after
the user completes the Google consent flow on the client side).</p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-auth-google"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-auth-logout">POST /api/v1/auth/logout  [auth:sanctum]
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-auth-me">GET /api/v1/auth/me  [auth:sanctum]
Return the authenticated user&#039;s profile.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-auth-me">PUT /api/v1/auth/me  [auth:sanctum]
Update the authenticated user&#039;s name and/or phone.</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-auth-me"
               value="b"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>b</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-v1-auth-me"
...
<p>Must not be greater than 20 characters. Example: <code>ngzmiyvdljnikhwa</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories">GET /api/v1/categories
Return the full active category tree (root categories + nested children).</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-categories--slug-">GET /api/v1/categories/{slug}
Return a single category with its paginated active products.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/categories/16" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/categories/16"
);
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-categories--slug-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The slug of the category. Example: <code>16</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-v1-products">List products</h2>

<p>
</p>

<p>Returns a paginated list of active products with optional filters.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/products?page=1&amp;per_page=15&amp;category=smartphones&amp;sort=newest&amp;min_price=100000&amp;max_price=5000000&amp;in_stock=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter by category slug. Example: <code>smartphones</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Sort order: price_asc, price_desc, name_asc, name_desc, newest. Example: <code>newest</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="query">
    <br>
<p>Maximum price filter. Example: <code>5000000</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>in_stock</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="in_stock"                data-endpoint="GETapi-v1-products"
               value="1"
               data-component="query">
    <br>
<p>Set to 1 to return only in-stock products. Example: <code>1</code></p>
            </div>
                </form>

                    <h2 id="endpoints-GETapi-v1-products--slug-">Get product detail</h2>

<p>
</p>

<p>Returns full product detail including images, videos, SEO meta, and JSON-LD schemas.</p>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/products/iphone-15" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/products/iphone-15"
);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The product slug. Example: <code>iphone-15</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-v1-search">GET /api/v1/search?q={term}&amp;type={products|blog|all}&amp;page={n}&amp;per_page={n}</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Full-text search via Meilisearch (Scout). Falls back to Eloquent LIKE
queries when SCOUT_DRIVER=null or Meilisearch is unreachable.</p>
...
<p>Must be at least 1. Must not be greater than 100. Example: <code>7</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-cart">GET /api/v1/cart
Return the current cart. Creates one if none exists.</h2>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;X-Session-ID header is required for guest carts.&quot;
}</code>
 </pre>
    </span>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-cart">DELETE /api/v1/cart
Remove all items from the cart.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-cart-items">POST /api/v1/cart/items
Add a product to the cart. Increments quantity if already present.</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID. The <code>id</code> of an existing record in the products table. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must be at least 1. Example: <code>67</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-cart-items--cartItem_id-">PUT /api/v1/cart/items/{cartItem}
Set an item&#039;s quantity to an exact value.</h2>
...
<span id="example-requests-PUTapi-v1-cart-items--cartItem_id-">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PUTapi-v1-cart-items--cartItem_id-">
</span>
<span id="execution-results-PUTapi-v1-cart-items--cartItem_id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PUTapi-v1-cart-items--cartItem_id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PUTapi-v1-cart-items--cartItem_id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PUTapi-v1-cart-items--cartItem_id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PUTapi-v1-cart-items--cartItem_id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PUTapi-v1-cart-items--cartItem_id-" data-method="PUT"
      data-path="api/v1/cart/items/{cartItem_id}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PUTapi-v1-cart-items--cartItem_id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PUTapi-v1-cart-items--cartItem_id-"
                    onclick="tryItOut('PUTapi-v1-cart-items--cartItem_id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-cart-items--cartItem_id-"
                    onclick="cancelTryOut('PUTapi-v1-cart-items--cartItem_id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PUTapi-v1-cart-items--cartItem_id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PUTapi-v1-cart-items--cartItem_id-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PUTapi-v1-cart-items--cartItem_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PUTapi-v1-cart-items--cartItem_id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="PUTapi-v1-cart-items--cartItem_id-"
               value="16"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>16</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-cart-items--cartItem_id-">DELETE /api/v1/cart/items/{cartItem}
Remove a single item from the cart.</h2>
...
<p>The ID of the cartItem. Example: <code>2</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-cart-merge">POST /api/v1/cart/merge  [auth:sanctum]
Merge guest cart into the authenticated user&#039;s cart.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://127.0.0.1:8000/api/v1/cart/merge" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="session_id"                data-endpoint="POSTapi-v1-cart-merge"
               value="6ff8f7f6-1eb3-3525-be4a-3932c805afed"
               data-component="body">
    <br>
<p>Must be a valid UUID. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-addresses">GET /api/v1/addresses</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-addresses">POST /api/v1/addresses</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address_line"                data-endpoint="POSTapi-v1-addresses"
               value="y"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="district"                data-endpoint="POSTapi-v1-addresses"
               value="c"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="ward"                data-endpoint="POSTapi-v1-addresses"
               value="m"
               data-component="body">
    <br>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-addresses--id-">PUT/PATCH /api/v1/addresses/{address}</h2>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="address_line"                data-endpoint="PUTapi-v1-addresses--id-"
               value="y"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>y</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="district"                data-endpoint="PUTapi-v1-addresses--id-"
               value="c"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>c</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="ward"                data-endpoint="PUTapi-v1-addresses--id-"
               value="m"
               data-component="body">
    <br>
<p>Must not be greater than 100 characters. Example: <code>m</code></p>
...
<p>Example: <code>false</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-addresses--id-">DELETE /api/v1/addresses/{address}</h2>
...
<p>The ID of the address. Example: <code>019d9c3f-73cc-7151-8943-e16f86ac65c5</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-v1-addresses--address_id--default">PATCH /api/v1/addresses/{address}/default</h2>
...
<span id="example-requests-PATCHapi-v1-addresses--address_id--default">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-v1-addresses--address_id--default">
</span>
<span id="execution-results-PATCHapi-v1-addresses--address_id--default" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-addresses--address_id--default"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-addresses--address_id--default"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-addresses--address_id--default" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-addresses--address_id--default">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-addresses--address_id--default" data-method="PATCH"
      data-path="api/v1/addresses/{address_id}/default"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-addresses--address_id--default', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-addresses--address_id--default"
                    onclick="tryItOut('PATCHapi-v1-addresses--address_id--default');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-addresses--address_id--default"
                    onclick="cancelTryOut('PATCHapi-v1-addresses--address_id--default');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-addresses--address_id--default"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-purple">PATCH</small>
            <b><code>api/v1/addresses/{address_id}/default</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-addresses--address_id--default"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-addresses--address_id--default"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-addresses--address_id--default"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the address. Example: <code>019d9c3f-73cc-7151-8943-e16f86ac65c5</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-orders">GET /api/v1/orders
Paginated order history for the authenticated user.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-orders">POST /api/v1/orders
Place a new order from the current cart.</h2>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --data "{
    \"address_id\": \"6ff8f7f6-1eb3-3525-be4a-3932c805afed\",
    \"note\": \"g\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="address_id"                data-endpoint="POSTapi-v1-orders"
               value="6ff8f7f6-1eb3-3525-be4a-3932c805afed"
               data-component="body">
    <br>
<p>Must be a valid UUID. The <code>id</code> of an existing record in the addresses table. Example: <code>6ff8f7f6-1eb3-3525-be4a-3932c805afed</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Must not be greater than 500 characters. Example: <code>g</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-orders--order_id-">GET /api/v1/orders/{order}
Single order detail. Policy ensures user owns the order.</h2>
...
<p>The ID of the order. Example: <code>019d9c46-b6de-70f0-b20a-62f22906da14</code></p>
                    ...
                    <h2 id="endpoints-PATCHapi-v1-orders--order_id--cancel">PATCH /api/v1/orders/{order}/cancel
Cancel a pending order. Policy ensures user owns the order.</h2>
...
<span id="example-requests-PATCHapi-v1-orders--order_id--cancel">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-PATCHapi-v1-orders--order_id--cancel">
</span>
<span id="execution-results-PATCHapi-v1-orders--order_id--cancel" hidden>
    <blockquote>Received response<span
                id="execution-response-status-PATCHapi-v1-orders--order_id--cancel"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-PATCHapi-v1-orders--order_id--cancel"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-PATCHapi-v1-orders--order_id--cancel" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-PATCHapi-v1-orders--order_id--cancel">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-PATCHapi-v1-orders--order_id--cancel" data-method="PATCH"
      data-path="api/v1/orders/{order_id}/cancel"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('PATCHapi-v1-orders--order_id--cancel', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-PATCHapi-v1-orders--order_id--cancel"
                    onclick="tryItOut('PATCHapi-v1-orders--order_id--cancel');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PATCHapi-v1-orders--order_id--cancel"
                    onclick="cancelTryOut('PATCHapi-v1-orders--order_id--cancel');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-PATCHapi-v1-orders--order_id--cancel"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="PATCHapi-v1-orders--order_id--cancel"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="PATCHapi-v1-orders--order_id--cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="PATCHapi-v1-orders--order_id--cancel"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<p>The ID of the order. Example: <code>019d9c46-b6de-70f0-b20a-62f22906da14</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-blog">GET /api/v1/blog</h2>
...
<span id="example-requests-GETapi-v1-blog">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-GETapi-v1-blog">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-blog" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-blog"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-blog"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-blog" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-blog">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-blog" data-method="GET"
      data-path="api/v1/blog"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-blog', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-blog"
                    onclick="tryItOut('GETapi-v1-blog');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-blog"
                    onclick="cancelTryOut('GETapi-v1-blog');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-blog"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-blog"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-blog"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-blog"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-blog-categories">GET /api/v1/blog/categories
Returns the full tree: root categories with children eager-loaded.</h2>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-blog-categories"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-blog-tags">GET /api/v1/blog/tags</h2>
...
<span id="example-requests-GETapi-v1-blog-tags">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/blog/tags" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/blog/tags"
);
...
<span id="example-responses-GETapi-v1-blog-tags">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-blog-tags" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-blog-tags"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-blog-tags"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-blog-tags" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-blog-tags">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-blog-tags" data-method="GET"
      data-path="api/v1/blog/tags"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-blog-tags', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-blog-tags"
                    onclick="tryItOut('GETapi-v1-blog-tags');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-blog-tags"
                    onclick="cancelTryOut('GETapi-v1-blog-tags');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-blog-tags"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/blog/tags</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-blog-tags"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-blog-tags"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-blog-tags"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-blog--slug-">GET /api/v1/blog/{slug}</h2>
...
<span id="example-requests-GETapi-v1-blog--slug-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/blog/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/blog/architecto"
);
...
<span id="example-responses-GETapi-v1-blog--slug-">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-blog--slug-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-blog--slug-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-blog--slug-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-blog--slug-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-blog--slug-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-blog--slug-" data-method="GET"
      data-path="api/v1/blog/{slug}"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-blog--slug-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-blog--slug-"
                    onclick="tryItOut('GETapi-v1-blog--slug-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-blog--slug-"
                    onclick="cancelTryOut('GETapi-v1-blog--slug-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-blog--slug-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/blog/{slug}</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-blog--slug-"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-blog--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-blog--slug-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="GETapi-v1-blog--slug-"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the blog. Example: <code>architecto</code></p>
            </div>
                    </form>

                    <h2 id="endpoints-GETapi-v1-blog--slug--comments">GET /api/v1/blog/{slug}/comments
Paginated approved comments for a published post.</h2>
...
<span id="example-requests-GETapi-v1-blog--slug--comments">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://127.0.0.1:8000/api/v1/blog/architecto/comments" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://127.0.0.1:8000/api/v1/blog/architecto/comments"
);
...
<span id="example-responses-GETapi-v1-blog--slug--comments">
            <blockquote>
            <p>Example response (404):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-v1-blog--slug--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-blog--slug--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-blog--slug--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-blog--slug--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-blog--slug--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-blog--slug--comments" data-method="GET"
      data-path="api/v1/blog/{slug}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-blog--slug--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-blog--slug--comments"
                    onclick="tryItOut('GETapi-v1-blog--slug--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-blog--slug--comments"
                    onclick="cancelTryOut('GETapi-v1-blog--slug--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-blog--slug--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/blog/{slug}/comments</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Authorization</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="GETapi-v1-blog--slug--comments"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-blog--slug--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-blog--slug--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="GETapi-v1-blog--slug--comments"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the blog. Example: <code>architecto</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-blog--slug--comments">POST /api/v1/blog/{slug}/comments  (auth:sanctum)
Submit a comment — stored as is_approved=false until admin approves.</h2>
...
<span id="example-requests-POSTapi-v1-blog--slug--comments">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-blog--slug--comments">
</span>
<span id="execution-results-POSTapi-v1-blog--slug--comments" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-blog--slug--comments"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-blog--slug--comments"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-blog--slug--comments" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-blog--slug--comments">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-blog--slug--comments" data-method="POST"
      data-path="api/v1/blog/{slug}/comments"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-blog--slug--comments', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-blog--slug--comments"
                    onclick="tryItOut('POSTapi-v1-blog--slug--comments');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-blog--slug--comments"
                    onclick="cancelTryOut('POSTapi-v1-blog--slug--comments');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-blog--slug--comments"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Authorization" class="auth-value"               data-endpoint="POSTapi-v1-blog--slug--comments"
               value="Bearer {YOUR_AUTH_KEY}"
               data-component="header">
    <br>
<p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-blog--slug--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-blog--slug--comments"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="slug"                data-endpoint="POSTapi-v1-blog--slug--comments"
               value="architecto"
               data-component="url">
    <br>
<p>The slug of the blog. Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="body"                data-endpoint="POSTapi-v1-blog--slug--comments"
               value="b"
               data-component="body">
    <br>
<p>Must be at least 3 characters. Must not be greater than 2000 characters. Example: <code>b</code></p>
        </div>
        </form>
